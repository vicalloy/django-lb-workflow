...
def load_issue():
    ...
    create_activity('5f31d065-00a0-0020-beea-641f0a670010', process, 'Draft', status='draft')  # test for update
    ...
    create_activity('5f31d065-00a0-0020-beea-641f0a670050', process, 'A1', operators='[owner]')
