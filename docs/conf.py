...
latex_documents = [
    (master_doc, 'django-lb-workflow.tex', 'django-lb-workflow Documentation',
     'vicalloy', 'manual'),
]
...
man_pages = [
    (master_doc, 'django-lb-workflow', 'django-lb-workflow Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'django-lb-workflow', 'django-lb-workflow Documentation',
     author, 'django-lb-workflow', 'One line description of project.',
     'Miscellaneous'),
]
